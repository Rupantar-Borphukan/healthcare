  ...
  <h3 align="center">A HealthCare Management System</h3>
   ...
   <div align="center">
     Build this project step by step for Health Care in rural and urban cities around the world.
    </div>
</div>
...
This repository contains the code corresponding to an in-depth video tutorial in youtube!! 
...
```bash
git clone https://github.com/Rupantar-Borphukan/healthcare.git
cd healthcare
```
